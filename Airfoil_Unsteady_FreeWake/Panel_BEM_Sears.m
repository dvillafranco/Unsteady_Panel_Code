...
load Panel_unsteady_maxpoints_flat.mat
c = 1;
...
grid on
set(gca,'FontSize',16);
leg1 = legend('BEM Code Signal','Panel Code Signal');
...
hold on;
hp2 = semilogy(f_BEM*pi,abs(fer_BEM/vortstrength)./exp(-f*h*pi)*pi);
...
ylabel('Magnitude of Lift Coefficient FFT Result');
xlim([ 0 20]);
