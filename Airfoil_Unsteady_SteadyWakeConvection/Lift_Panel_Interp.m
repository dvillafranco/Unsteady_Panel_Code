...
% trailing edge
clear L_front L_back time_good lift_good time_query
rho = 1;
c = 1;
h = 0.02;
time = 0.001:0.001:20;
...
before_dip      = 8568;    %400; 500    906
after_dip       = 9550;   %530;  620   1061
...
time_good = time(21:end);
lift_good = L_unsteady_fix(21:end);
time_query = time(1:20);
